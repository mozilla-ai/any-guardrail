...
GUARDRAIL_METADATA: dict[GuardrailName, GuardrailMetadata] = {
    ...
    GuardrailName.GLI_NER_PII: GuardrailMetadata(
        description="Span-level PII/NER detector emitting character spans and a redacted copy of the text.",
        display_name="GLiNER2 PII",
        categories=frozenset({GuardrailCategory.PII}),
        primary_category=GuardrailCategory.PII,
        stages=frozenset({GuardrailStage.INPUT, GuardrailStage.OUTPUT}),
        output_shapes=frozenset({OutputShape.SPAN, OutputShape.MULTI_LABEL}),
        backend=BackendType.LIBRARY_WRAPPED,
        optional_validate_kwargs=frozenset({"entity_types", "threshold", "redaction_placeholder"}),
        multilingual=True,
        vendor="Fastino",
        default_license="apache-2.0",
    ),
    GuardrailName.WATSONX_GUARDIAN: GuardrailMetadata(
        ...
        primary_category=GuardrailCategory.CONTENT_SAFETY,
        stages=frozenset({GuardrailStage.INPUT, GuardrailStage.OUTPUT, GuardrailStage.RAG_CONTEXT}),
        output_shapes=frozenset({OutputShape.MULTI_LABEL, OutputShape.SPAN, OutputShape.SCORE}),
        backend=BackendType.HOSTED_API,
        requires_api_key=True,
        vendor="IBM",
        default_license="proprietary",
    ...
    GuardrailName.QWEN3_GUARD_STREAM: GuardrailMetadata(
        ...
        primary_category=GuardrailCategory.CONTENT_SAFETY,
        stages=frozenset({GuardrailStage.INPUT, GuardrailStage.OUTPUT}),
        output_shapes=frozenset({OutputShape.CATEGORICAL, OutputShape.SPAN, OutputShape.SCORE}),
        backend=BackendType.LOCAL_DECODER,
        optional_validate_kwargs=frozenset({"output_text"}),
        multilingual=True,
        vendor="Qwen",
