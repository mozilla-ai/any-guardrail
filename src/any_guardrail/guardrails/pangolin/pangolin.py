...
class Pangolin(ThreeStageGuardrail[dict[str, Any], dict[str, Any], bool, None, float]):
    ...
    def _post_processing(
        ...
        return match_injection_label(model_outputs, PANGOLIN_INJECTION_LABEL, self.provider.model.config.id2label)
