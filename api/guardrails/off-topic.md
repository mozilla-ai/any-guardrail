...
| `provider` | `Optional[Provider[dict[str, Any], dict[str, Any]]]` | No | `None` | Reserved for future extensibility; currently unused. The selected implementation loads its model directly via ``transformers``. |
